...
ALTER FUNCTION public.update_fecha_actualizacion() OWNER TO neondb_owner;
...
ALTER TABLE public.cargo OWNER TO neondb_owner;
...
ALTER SEQUENCE public.cargo_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.empresa OWNER TO neondb_owner;
...
ALTER SEQUENCE public.empresa_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.estado OWNER TO neondb_owner;
...
ALTER SEQUENCE public.estado_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.fase_seguimiento OWNER TO neondb_owner;
...
ALTER SEQUENCE public.fase_seguimiento_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.metodo_evaluacion OWNER TO neondb_owner;
...
ALTER SEQUENCE public.metodo_evaluacion_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.modalidad OWNER TO neondb_owner;
...
ALTER SEQUENCE public.modalidad_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.nivel_experiencia OWNER TO neondb_owner;
...
ALTER SEQUENCE public.nivel_experiencia_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.plataforma OWNER TO neondb_owner;
...
ALTER SEQUENCE public.plataforma_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.postulacion OWNER TO neondb_owner;
...
ALTER SEQUENCE public.postulacion_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.postulacion_metodo OWNER TO neondb_owner;
...
ALTER TABLE public.postulacion_seguimiento OWNER TO neondb_owner;
...
ALTER SEQUENCE public.postulacion_seguimiento_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.postulacion_tecnologia OWNER TO neondb_owner;
...
ALTER TABLE public.tecnologia OWNER TO neondb_owner;
...
ALTER SEQUENCE public.tecnologia_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.ubicacion OWNER TO neondb_owner;
...
ALTER SEQUENCE public.ubicacion_id_seq OWNER TO neondb_owner;
...
INSERT INTO public.cargo VALUES (9, 'Analista de AutomatizaciÃ³n y Datos', '2026-05-07 06:23:54.047133-04', 0, 1);
INSERT INTO public.cargo VALUES (10, 'Soporte InformÃ¡tico', '2026-05-13 05:30:59.496643-04', 0, 1);
...
INSERT INTO public.empresa VALUES (10, 'BC TecnlogÃ­a', '2026-05-07 06:23:27.769747-04', 1);
...
INSERT INTO public.fase_seguimiento VALUES (1, 'PostulaciÃ³n enviada', '#22c55e', 'send', 10, false, '2026-06-08 02:31:08.834537');
INSERT INTO public.fase_seguimiento VALUES (2, 'Contacto inicial', '#38bdf8', 'phone', 20, false, '2026-06-08 02:31:08.834537');
INSERT INTO public.fase_seguimiento VALUES (3, 'Prueba tÃ©cnica', '#8b5cf6', 'file-code', 30, false, '2026-06-08 02:31:08.834537');
INSERT INTO public.fase_seguimiento VALUES (4, 'Entrevista RRHH', '#06b6d4', 'users', 40, false, '2026-06-08 02:31:08.834537');
INSERT INTO public.fase_seguimiento VALUES (5, 'Entrevista tÃ©cnica', '#6366f1', 'monitor-code', 50, false, '2026-06-08 02:31:08.834537');
...
INSERT INTO public.metodo_evaluacion VALUES (5, 'Entrevista TÃ©cnica', '#8b5cf6', '2026-05-05 03:36:04.186483-04', 1);
...
INSERT INTO public.modalidad VALUES (3, 'HÃ­brido', '#f59e0b', '2026-05-05 03:36:04.186483-04', 1);
...
INSERT INTO public.tecnologia VALUES (17, 'InglÃ©s', NULL, '#6b7280', '2026-05-05 03:36:04.186483-04', 0, 1);
...
INSERT INTO public.tecnologia VALUES (35, 'Soporte TÃ©cnico', NULL, '#61dafb', '2026-05-13 05:46:53.686318-04', 0, 1);
...
INSERT INTO public.ubicacion VALUES (3, 'ValparaÃ­so', '2026-05-05 03:36:04.186483-04', 1);
INSERT INTO public.ubicacion VALUES (4, 'ConcepciÃ³n', '2026-05-05 03:36:04.186483-04', 1);
INSERT INTO public.ubicacion VALUES (5, 'ViÃ±a del Mar', '2026-05-05 03:36:04.186483-04', 1);
